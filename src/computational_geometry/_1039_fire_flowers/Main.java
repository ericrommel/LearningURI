package computational_geometry._1039_fire_flowers;
	...
	public static void main(String[] args) throws IOException {
		...
		while ((str=in.readLine()) != null) {
			...
			while (st.hasMoreTokens()) {
				r1 = Integer.parseInt(st.nextToken()); // Raio do ca�ador
				x1 = Integer.parseInt(st.nextToken()); // Centro do c�rculo do ca�ador
				y1 = Integer.parseInt(st.nextToken()); // Centro do c�rculo do ca�ador
				r2 = Integer.parseInt(st.nextToken()); // Raio da flor
				x2 = Integer.parseInt(st.nextToken()); // Centro do c�rculo da flor
				y2 = Integer.parseInt(st.nextToken()); // Centro do c�rculo da flor
