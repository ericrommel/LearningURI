package beginners._1016_distance;
...
//		int minutes;
		 ...
		 * - Ap�s 60 minutos, o CarY estar� 30Km (90km-60km) na frente do Carro X.
		 * Colocando na regra de tr�s, temos:
		 * 60min -- (30)
		 * X min -- Distancia
		 * X = (Distancia * 60)/30
		 */
		//minutes = (Integer.parseInt(in.readLine())*60)/30;
		out.write(((Integer.parseInt(in.readLine())*60)/30) + " minutos\n");
		in.close();
		out.flush();
	}
